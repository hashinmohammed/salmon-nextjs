            ...
            >
              {cards.map((card, idx) => (
                <SwiperSlide key={idx} className="pb-8 pt-4">
                  <div className="relative flex flex-col justify-end rounded-2xl shadow-lg  p-4 mx-auto min-h-[300px] h-full max-w-xs transition-transform duration-300 hover:scale-105 overflow-hidden">
                    {/* Card background pattern using Next.js Image */}
                    <Image
                    ...
                    />
                    {/* Card content */}
                    <div className="relative w-full h-full rounded-xl overflow-hidden flex-1 z-10">
                      <Image
                        src={card.image}
                        alt={card.title}
                        fill
